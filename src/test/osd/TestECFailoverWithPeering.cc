 ...
 *
 * Expected behavior WITHOUT fix: Crash with assertion failure:
 *   /home/akupczyk/ceph-1/src/osd/ECCommon.cc: 499: FAILED ceph_assert(reads_sent)
 *
 * Expected behavior WITH fix: Test completes successfully, possibly with some
 * read errors but no crash.
 */
